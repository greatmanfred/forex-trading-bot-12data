...
def regime_score(df):
    ...
    regime_score_value = 0

    if atr > atr_mean * 1.05:
        regime_score_value += 35
    ...
    if atr < atr_mean * 0.85:
        regime_score_value -= 20

    return max(regime_score_value, 0)
